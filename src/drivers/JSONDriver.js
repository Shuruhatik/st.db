...
class JSONDriver extends CacheDriver_1.CacheDriver {
    constructor(path = "data", path_resolve = true) {
        super();
        this.path = (0, utils_1.pathResolve)(path, "json", path_resolve);
    ...
    writeFile(data = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield (0, node_fs_1.writeFileSync)(this.path, JSON.stringify(data, null, 4));
        });
    }
    readFile() {
        if (!(0, node_fs_1.existsSync)(this.path))
